...
a fraction of the code and behaves better — smoother damping, no edge cases I
had to think through myself.
...
with no bindings yet, left for the player-controller work still to come —
there was no reason to guess at bindings before there's a controller to test
them against.
